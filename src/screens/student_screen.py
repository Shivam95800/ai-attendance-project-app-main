                ...
                if new_name:
                    with st.spinner('Creating profile..'):
                        ...
                        if encodings:
                            ...
                            # FIXED LOGIC BLOCK HERE
                            if response_data:
                                train_classifier()
                                
                                # Clear cached face model
                                ...
                                st.error("Student registration failed in database.")
                        else:
                            st.error("Couldn't capture facial features. Please try again with better lighting.")
                else:
